...
function getBytes(transaction) {
	...
	bb.writeByte(transaction.network); // din = 0x17, testnet = 0x30
...
function getKeys(secret, network) {
	var ecpair = ECPair.fromSeed(secret, network || networks.din);
